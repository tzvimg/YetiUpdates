...
-->*}
{strip}
<div id="sendSmsContainer" class='modelContainer' style="text-align: right;">
	...
	<form class="form-horizontal" id="massSave" method="post" action="index.php">
		...
		<div class="modal-body tabbable">
			<div>
				<span><strong>{vtranslate('LBL_STEP_0',$MODULE)}</strong></span>
				&nbsp;:&nbsp;
				{vtranslate('LBL_TYPE_THE_SRC_NUMBER',$MODULE)}&nbsp;(&nbsp;{vtranslate('LBL_SMS_SRC_MAX_CHARACTERS_ALLOWED',$MODULE)}&nbsp;)
			</div>
			<input type="text" class="input-xxlarge" name="sourceNumber" id="sourceNumber" placeholder="{vtranslate('SMS_SRC_NUMBER', $MODULE)}"></input>
			<hr>
			<div>
